...
namespace DairyApp.Controllers
{
    ...
    public class OrderInfoController : ControllerBase
    {
        ...
        //                            AddressInfo = reader["AddressInfo"].ToString(),
        //                            OrderDetailsInfo = reader["OrderDetailsInfo"].ToString(),
        //                            PaymentMethod = reader["PaymentMethod"].ToString()
        //                        };
        ...
        //        {
        //            con.Open();
        //            using (SqlCommand cmd = new SqlCommand("SELECT * FROM OrderInfo WHERE Order_Id = @Order_Id", con))
        //            {
